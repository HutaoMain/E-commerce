...
const UpdateVariation = () => {
  ...
  }, [data.variationName, data.price, data.quantity]);
    ...
    <div className="addCategory">
      ...
      <div className="addCategoryContainer">
        ...
        <div className="addCategoryTitle">
          <h1>Update Product Variation</h1>
        </div>
        <div className="addCatLeftRightContainer">
          <div className="addCategoryLeft">
            <img
              src={
                ImageFile ? window.URL.createObjectURL(ImageFile) : data.imgUrl
              }
              alt="AddImage"
            />
          </div>
            ...
            <form className="addCategoryForm">
              ...
              <div className="addCategoryItem">
                <input
                  ...
                  defaultValue={data.variationName}
                  onChange={(e) => {
                    setInfo((data) => ({
                      ...data,
              ...
              <div className="addVariationNumber" style={{ marginBottom: "0" }}>
              ...
              <button className="addCategoryBtn" onClick={toggleModalCategory}>
                <MdOutlineDownloadDone /> Update Product Variation
              </button>
              <Modal
                isOpen={isOpenModal}
